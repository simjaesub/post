...
for i in range(-25, 25, 4):
    y = i + center[1]
    plt.hlines(y, center[0] - np.sqrt(r ** 2 - (y - center[1]) ** 2),
               center[0] + np.sqrt(r ** 2 - (y - center[1]) ** 2), colors='k', linestyle='solid')
for i in range(-25, 25, 4):
    x = i + center[0]
    plt.vlines(x, center[1] - np.sqrt(r ** 2 - (x - center[0]) ** 2),
               center[1] + np.sqrt(r ** 2 - (x - center[0]) ** 2), colors='k', linestyle='solid')
...
for i in range(-25, 25, 4):
    y = i + center2[1]
    plt.hlines(y, center2[0] - np.sqrt(r ** 2 - (y - center2[1]) ** 2),
               center2[0] + np.sqrt(r ** 2 - (y - center2[1]) ** 2), colors='firebrick', linestyle='solid', alpha=0.5)
for i in range(-25, 25, 4):
    x = i + center2[0]
    plt.vlines(x, center2[1] - np.sqrt(r ** 2 - (x - center2[0]) ** 2),
